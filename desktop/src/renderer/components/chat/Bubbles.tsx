  ...
  return (
    <div className="flex items-end gap-[10px] animate-rise">
      ...
      <div className="max-w-[78%]">
        <div className="rounded-[16px_16px_16px_5px] border border-surface-3 bg-[#181A20] px-[14px] py-[11px] text-[14px] leading-[1.5] text-[#DDE0E6]">{text}</div>
        {tools && tools.length > 0 && (
          <div className="mt-[5px] inline-flex items-center gap-1 rounded-full border border-border-subtle bg-[#111217] px-2 py-[2px] text-[10.5px] font-medium text-content-muted">
            🔧 {tools.join(", ")}
          </div>
        )}
      </div>
...
export function UserBubble({ text }: { text: string }) {
  return (
    <div className="flex justify-end animate-rise">
      <div className="max-w-[78%] rounded-[16px_16px_5px_16px] border border-[#34373F] bg-[#22242B] px-[14px] py-[11px] text-[14px] leading-[1.5] text-content">{text}</div>
    </div>
  );
}
...
export function ToldYouSo({ text }: { text: string }) {
  return (
    <div className="relative mt-1 overflow-hidden rounded-[16px] border border-[#3A3320] bg-[#100F0A] px-[15px] py-[13px] animate-rise">
      ...
      <div className="text-[14px] leading-[1.5] text-[#DDE0E6]">{text}</div>
    </div>
  );
}
...
export function Typing() {
  return (
    <div className="flex items-end gap-[10px]">
      <AgentGlyph size={28} />
      <div className="flex gap-[5px] rounded-[16px_16px_16px_5px] border border-surface-3 bg-[#181A20] px-4 py-[13px]">
